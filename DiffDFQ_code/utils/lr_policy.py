...
class LRPolicy:
    ...
    def set_params(self, params_dict=None):
        ...
        if self.lr_policy == "multi_step":
            ...
            """
            params: custom_lr_schedule
            custom: lr is set to different constants based on epoch ranges
            """
            self.params_dict['custom_lr_schedule'] = params_dict['custom_lr_schedule']
    ...
    def get_lr(self, epoch):
        ...
        if self.lr_policy == "multi_step":
            ...
            for epoch_range, lr_value in self.params_dict['custom_lr_schedule']:
